<section class="space-y-6">
    <header>
        ...
        <p class="mt-2 mb-6 text-lg text-gray-600 dark:text-gray-400">
            <?php echo e(__('Depois que a sua conta for excluída, todos os seus recursos e dados serão permanentemente apagados. Antes de excluir a sua conta, por favor, baixe quaisquer dados ou informações que você deseja manter.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-2xl font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('Tem a certeza que quer excluir a sua conta?')); ?>

            </h2>

            <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">
                <?php echo e(__('Uma vez que a sua conta for excluída, todos os seus recursos e dados serão permanentemente apagados. Por favor, digite a sua senha para confirmar que você deseja excluir permanentemente a sua conta.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-3/4 !text-lg','placeholder' => ''.e(__('Senha')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-3/4 !text-lg','placeholder' => ''.e(__('Senha')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</section><?php /**PATH C:\xampp\htdocs\CarStore\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>